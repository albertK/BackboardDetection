...
#if DBG
    printf("Kinect elevation angle = %f\n", theta_x/3.14159*180.0);
#endif
...
{
    Eigen::Vector3f heading(0.0, 0.0, 1.0);
    float cos_theta = shoot_goal.dot(heading);
    float sin_theta = (shoot_goal.cross(heading)).norm();
