...
void ransac_line_detection(std::vector<cv::Point2d>& points, int iteration, double thres, std::vector<double> coeff, std::vector<int> inliers)
{
    //Note that the line equation is assumed to be: ax+by+c=0
